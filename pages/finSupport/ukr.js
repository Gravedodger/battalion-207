    ...
    return <>
        ...
        >
            ...
            >
                ...
                <Text mb='1rem' color={textColor}>
                    Однак, враховуючи тривалість нашого спротиву російсько-окупаційній навалі, збільшення чисельності
                ...
                <Text mb='1rem' fontWeight={700} color={textColor}>
                    ...
                    спільний мир та свободу, оберіть зручну для Вас валюту щоб дізнатися доступні
