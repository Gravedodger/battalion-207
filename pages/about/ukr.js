        ...
        <main>
            ...
            <Box className={styles.aboutArticle}>
                ...
                <Container className={styles.articleTxtContainer} fontSize='xl' textAlign='justify'>
                    <Text>
                        207-й батальйон 112-ої бригади Територіальної оборони м.Києва є окремим підрозділом у складі Збройних Сил України, підпорядкований Оперативному командуванню "Північ"
                        (в/ч А7376).
                    </Text>
