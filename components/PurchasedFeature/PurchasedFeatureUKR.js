...
const PurchasedFeatureUKR = () => {
    ...
    const itemId13Pic = <Image src='/Fuel/PistolHolder--07-04.jpg' alt='items purchase proof'/>;

    const itemId14 = <Text mt='0.2rem' color='#09A205'>+ Домкрат (2t.) => ₴ 1,570</Text>;
    const itemId14Pic = <Image src='/Fuel/Domkrat--08-04.jpg' alt='items purchase proof' />;

    const itemId15 = <Text mt='0.2rem' color='#09A205'>+ 2x лебідки (3.5t) => ₴ 2,831.96</Text> ;
    const itemId15Pic = <Image src='/Fuel/Wrenches--08-04.jpg' alt='items purchase proof' />;
    ...
    const itemId21Pic = <Image src='/Purhased/Plastic&Tape&Sandbags--13-04.jpg' alt='items purchase proof' />;
